...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []coinutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []coinutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee coinutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee coinutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address coinutil.Address, amount coinutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address coinutil.Address, amount coinutil.Amount) (*wire.ShaHash, error) {
...
func (c *Client) SendToAddressCommentAsync(address coinutil.Address,
	amount coinutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address coinutil.Address, amount coinutil.Amount, comment, commentTo string) (*wire.ShaHash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress coinutil.Address, amount coinutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress coinutil.Address, amount coinutil.Amount) (*wire.ShaHash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress coinutil.Address, amount coinutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress coinutil.Address, amount coinutil.Amount, minConfirms int) (*wire.ShaHash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress coinutil.Address, amount coinutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress coinutil.Address,
	amount coinutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[coinutil.Address]coinutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[coinutil.Address]coinutil.Amount) (*wire.ShaHash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[coinutil.Address]coinutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[coinutil.Address]coinutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (coinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return coinutil.DecodeAddress(addr, &chaincfg.MainNetParams)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []coinutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []coinutil.Address, account string) (coinutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []coinutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []coinutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (coinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (coinutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (coinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (coinutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (coinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (coinutil.Address, error) {
...
func (c *Client) GetAccountAsync(address coinutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address coinutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address coinutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address coinutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]coinutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]coinutil.Address, 0, len(addrStrings))
	for _, addrStr := range addrStrings {
		addr, err := coinutil.DecodeAddress(addrStr,
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]coinutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount coinutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount coinutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount coinutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount coinutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount coinutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount coinutil.Amount,
...
func (c *Client) ValidateAddressAsync(address coinutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address coinutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]coinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]coinutil.Amount)
	for k, v := range accounts {
		amount, err := coinutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]coinutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]coinutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (coinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := coinutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (coinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (coinutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (coinutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (coinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (coinutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (coinutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (coinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (coinutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (coinutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address coinutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address coinutil.Address) (coinutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address coinutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address coinutil.Address, minConfirms int) (coinutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address coinutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address coinutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address coinutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address coinutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*coinutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return coinutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address coinutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address coinutil.Address) (*coinutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *coinutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *coinutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *coinutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *coinutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *coinutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *coinutil.WIF, label string, rescan bool) error {
